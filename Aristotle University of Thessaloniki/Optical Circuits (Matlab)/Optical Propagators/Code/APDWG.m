function [ neff_TE , neff_TM , Ey_TE , Hy_TM ] = APDWG( wl , h , n1 , n2 , n3 , x )

% ADPWG -- Asymmetric Planar Dielectric WaveGuide (version Mar 2013)
%
% ==================================================================
% | Inputs:
% ==================================================================
...
%   Hy_TM   : profile(s) of Hy component, over the x-vector, 
    ...
    for kn = 1 : N
        ...
        switch kT
            case 1, 
                ...
                neff_TE(kn) = interp1( XE , ne , 0 , 'cubic');
                neTE(kn,:) = ne;
                XETE(kn,:) = XE;
            case 2, 
                XE = tan( k * h ) - k.*(gt+dt)./(k.^2-gt.*dt); %TM
                neff_TM(kn) = interp1( XE , ne , 0 , 'cubic' );
                neTM(kn,:) = ne;
                XETM(kn,:) = XE;
        end
